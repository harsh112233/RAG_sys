...
st.write("Upload a document and ask questions about the data. The app uses the document content and LLM-generated information to answer your queries. Supported file types: any readable text file.")
...
@st.cache_resource  # No 'show_progress' here
def init_chat_engine():
    try:
        documents = SimpleDirectoryReader("data").load_data()
        # Move show_progress to VectorStoreIndex.from_documents
...
st.sidebar.markdown("""
### Instructions
1. Place your documents in a `data/` folder next to this script.
